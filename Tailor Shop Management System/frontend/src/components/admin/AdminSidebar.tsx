...
const AdminSidebar = () => {
  ...
  const menuItems = [
    ...
    { label: "All Orders", path: "/admin/orders", icon: "fa-list" },
    { label: "Transactions", path: "/admin/transactions", icon: "fa-receipt" },
    { label: "Customers", path: "/admin/customers", icon: "fa-users" },
    { label: "Employees", path: "/admin/employees", icon: "fa-user-tie" },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <i className="fa-solid fa-gears text-[#1fb854] mr-1"></i>
