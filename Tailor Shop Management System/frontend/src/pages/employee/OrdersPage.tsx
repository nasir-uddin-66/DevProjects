// Employee OrdersPage - view assigned orders
...
export default function EmployeeOrdersPage() {
  ...
  const loadOrders = async () => {
    ...
    setLoading(true);
    try {
      let allOrders = await orderService.getOrders(user.id, "employee");
      if (activeTab !== "all") {
        ...
        <div className="bg-linear-to-r from-[#1fb854] to-[#178a3f] p-8 md:p-12">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-white opacity-90">
              Manage and track your tailoring orders
            </p>
          </div>
        </div>
          ...
          {orders.length > 0 && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-12">
              <div className="bg-linear-to-br from-[#282424] to-[#1b1717] rounded-lg p-6 border border-[#1fb854]">
                <p className="text-[#30ce67] text-sm mb-2">Total Assigned</p>
              ...
              <div className="bg-linear-to-br from-[#282424] to-[#1b1717] rounded-lg p-6 border border-[#f59e0b]">
                <p className="text-[#30ce67] text-sm mb-2">Pending Work</p>
